    ...
    <section class="py-5 bg-light">
        ...
        <section class="video-section"
            ...
            <div class="auto-container">
                ...
                <!-- 📝 Meal Planning Tips -->
    <section id="meal-tips" class="about-section py-5" style="background-color: #f0fdf7;">
        <div class="auto-container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="{{ URL::asset('website/images/resource/p1.png') }}" class="img-fluid rounded" alt="Meal Planning">
                </div>
                <div class="col-lg-6">
                    <h2 class="fw-bold text-success">Smart Meal Planning for Busy Families</h2>
                    <p>Here’s a simple weekly routine that makes meal planning easy and effective for parents with busy schedules.</p>
                    <ul class="text-start mt-3">
                        <li>📅 Plan meals Sunday morning over coffee with the kids.</li>
                        <li>🛒 Sync shopping lists via apps like OneNote or your phone.</li>
                        <li>🍕 Pre-cook Monday meals and enjoy family favorites midweek!</li>
                    </ul>
                    <a href="#printables" class="btn btn-success mt-3">Explore Printable Planners</a>
                </div>
            </div>
        </div>
    </section>
