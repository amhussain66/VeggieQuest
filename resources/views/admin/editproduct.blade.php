            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" class="MyForm" action="{{ route('admin.updateproducts') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="heading" class="form-control MyInput"
                                               placeholder="Heading" required value="{{ $product->heading }}">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3 MyFileInput" autocomplete="off"
                                               name="ingredients" placeholder="Ingredients" required
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3 MyFileInput" autocomplete="off"
                                               name="prepration_time" placeholder="Preparation Time" required
                                               value="{{ $product->prepration_time }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3 MyFileInput" autocomplete="off"
                                               name="serve" placeholder="No of Person Serve" required
                                               value="{{ $product->serve }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control Description_1"
                                                  placeholder="Description" id="tinymceExample1"
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <center>
                                        <button class="btn btn-success MyButton">Update Products</button>
                                    </center>
                                </div>
